...
//    glutMainLoop();
    ...
    {
        theSmokeSim.step();
        std::string particleFile = "../records/frame" + std::to_string(i) + ".bgeo";
        theSmokeSim.mGrid.saveParticle(particleFile);
        //string str("../records/density" + std::to_string(i) + ".txt");
        //theSmokeSim.mGrid.saveSmoke(str.c_str());
        cout << particleFile << " done" << endl;
    }
    cout << "finished" << endl;
    return 0;             
}
